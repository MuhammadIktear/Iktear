...
/* ----- TYPING EFFECT ----- */
 var typingEffect = new Typed(".typedText",{
    strings : ["Django Backend Developer", "Competitive Programmer"],
    loop : true,
    typeSpeed : 80, 
    backSpeed : 80,
    backDelay : 1600
...
sr.reveal('.featured-text-btn',{delay: 160})
sr.reveal('.social_icons',{delay: 160})
sr.reveal('.featured-image',{delay: 250})

/* -- PROJECT BOX -- */
sr.reveal('.project-box',{interval: 160})

/* -- ACHIEVEMENT BOX -- */
sr.reveal('.achievement-box',{interval: 160})
